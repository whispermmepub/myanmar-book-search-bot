...
- စာအုပ်ကဒ်ပေါ်က `📖 အညွှန်းဖတ်ရန်` ခလုတ်နှိပ်လျှင် အညွှန်း (အပြည့်အစုံ) ကို သီးခြား message ဖြင့် ပြသည် (Group တွင် ၅ မိနစ်အကြာ auto-delete)။ ရှည်လျားသော အညွှန်းများကို ကာဗာပုံအောက်တွင် ဆက်မပြဘဲ ခလုတ်နှင့်သာ ဖွင့်ကြည့်နိုင်သည်။
- စာအုပ်ကဒ်ပေါ်က `🛒 စာအုပ်မှာရန်` ခလုတ်ကို နှိပ်လျှင် စာအုပ်တိုက်၏ Telegram DM သို့ စာအုပ်အချက်အလက် + ဝယ်ယူလိုသူ၏ အချက်အလက်ကို bot မှ ပို့ပေးပြီး ဝယ်သူက စာအုပ်တိုက်နှင့် တိုက်ရိုက် ဆက်သွယ်နိုင်သည်။

## Publisher contacts (စာအုပ်မှာရန်)
- `publisher_contacts.json` ထဲတွင် စာအုပ်တိုက်အမည် (sheet ထဲကအတိုင်း) နှင့် Telegram username ကို ထည့်ပါ:
  ```json
  {
    "ဆုပြည့်စုံထွန်းစာပေ": "some_username",
    "Quality Publishing House": "another_username"
  }
  ```
- အဲဒီ username ၏ အကောင့်က bot ကို `/start` လုပ်ပြီးဖူးမှသာ bot မှ DM ပို့နိုင်သည် (Telegram bot privacy ကြောင့်)။ မလုပ်ရသေးပါက ဝယ်သူအား တိုက်ရိုက် `t.me/username` လင့်သာ ပြပေးသည်။
- username ထည့်မထားသော စာအုပ်တိုက်များတွင် ခလုတ် မပေါ်ပါ။
