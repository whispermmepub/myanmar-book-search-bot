...
- စာအုပ်ကဒ်ပေါ်က `🛒 စာအုပ်မှာရန်` ခလုတ်ကို နှိပ်လျှင် စာအုပ်တိုက်၏ Telegram Channel ကို တိုက်ရိုက်ဖွင့်ပေးပြီး ဝယ်သူက channel ထဲဝင်ကာ သူ့ဘာသာ မှာယူနိုင်သည်။

## Publisher channels (စာအုပ်မှာရန်)
- `publisher_channels.json` ထဲတွင် စာအုပ်တိုက်အမည် (sheet ထဲကအတိုင်း) နှင့် Telegram channel link (သို့) username ကို ထည့်ပါ:
  ```json
  {
